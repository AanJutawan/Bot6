...
helpMessage =""" ✍(􀠁􀠁☆─┅═ই╬TEAM RANDY KILLS☆) 
...
Creator : By ✍(􀠁􀠁☆─┅═ই╬TEAM RANDY KILLS☆) 
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : http://line.me/ti/p/boy29putra",
    "lang":"JP",
    "comment":"Owner : http://line.me/ti/p/boy29putra",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-------------------------------------------------#
            elif msg.text in ["Tagall","Mention","Ats","Tag",]:
              if msg.from_ in admin:
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Powered By ─═অই £€47!€£ অ═─ه")         
#-----------------------------------------------
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                if Bots == [8]:
                    ...
                    for mi_d in Bots:
                        mc += "➳" +cl.getContact(mi_d).displayName + "\n"
                    cl.sendText(msg.to,"「 ✍DEDI TEAMBOT✈ 」\n" + mc +"Total : "+ str(len(Bots)))
...
#--------------------------------------------------
                ...
                ki.sendText(msg.to,"─═অই £€47!€£ অ═─ه")
                kk.sendText(msg.to,"─═অই £€47!€£ অ═─ه")
                kc.sendText(msg.to,"─═অই £€47!€£ অ═─ه")
                kd.sendText(msg.to,"─═অই £€47!€£ অ═─ه")
                ki.sendText(msg.to,"Semua hadir boss\nsiap menunggu perintah anda")
#--------------------------------------------------
...
#                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====Ready=====\n[★]🐯Bot Pʀᴏᴛᴇᴄᴛɪᴏɴѕ For Group\n[★]🐯Tickets Siri\n[★]🐯Sᴇʟꜰʙᴏᴛ in Your Account\n[★]🐯1 Selfbot 1 Bot Assist\n[★]🐯1 Selfbot 2 Bot Assist\n[★]🐯1 Selfbot 3 Bot Assist\n[★]🐯1 Selfbot 4 Bot Assist\n[★]🐯1 Selfbot 5 Bot Assist\n[★]🐯Ready Siri \n[★]🐯Admin Pʀᴏᴛᴇᴄᴛɪᴏɴѕ\n[★]🐯Staff Pʀᴏᴛᴇᴄᴛɪᴏɴѕ\n\nMinat??? PM Id Line http://line.me/ti/p/pjK1Od8ftK\n[★]✍D̴E̴D̴I̴ T̴E̴A̴M̴B̴O̴T̴✈[★]")                    print "Like"
#                except:
#                    pass
#            else:

...
wait = {
    ...
    "lang":"JP",
    "comment":"Thailand creator : SELFBOT-MAN-PC \n•─ ͜͡✫ѕєʟғвот[ᴍ̶̲̅ᴀ̶̲̅ɴ̶̲̅]κɪcκєʀ ͜͡✫─•\nรับทำเชลบอท [SelfBot] กันรัน\n•ชุดบอท Protect+Kicker\n•บอทแท๊ก Tag all  /  Mention\nสามม่ค้าออนไลท์ แท๊กเรียกลูกค้า ก่อนลงใบขายสินค้าของท่าน ผมว่ามันเจ๋งมากๆ (ราคาเบาๆ) สบายกระเป๋า\n•ชุดบอทบิน \n[เปิดสอนแล้ว]  วันนี้..\nสำหรับคนที่จะฝึกเขียนบอท ฝึกรันบนเซิร์ฟเวอร์\nสนใจติดต่อสอบถามครับ..⤵️\n https://line.me/ti/p/~1ove..neverdie",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#========================== B O T ``C O M M A N D =============================#
                ...
                msg.contentMetadata = {'mid': "ud24af63fd62d14c3bf8f719df80c3745"}
                cl.sendMessage(msg)
                cl.sendText(mag.to,"creator : SELFBOT-MAN-PC \n•─ ͜͡✫ѕєʟғвот[ᴍ̶̲̅ᴀ̶̲̅ɴ̶̲̅]κɪcκєʀ ͜͡✫─•\n📧https://line.me/ti/p/~1ove..neverdie")
